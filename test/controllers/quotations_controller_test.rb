...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { email: @quotation.email, message: @quotation.message, name: @quotation.name, subject: @quotation.subject } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { email: @quotation.email, message: @quotation.message, name: @quotation.name, subject: @quotation.subject } }
